...
//            }
    ...
    public String getCellType() {
        int userStatement = Repository.getUserAndroidIdState();
        if(userStatement != Constants.TAG_ANDROID_ID_STATEMENT_STATE_GRANT)return "";
        String mType="";
        int networkType=-1;
//        try{networkType=mTelephonyManager.getNetworkType();}catch(Exception e){}
//        try{
...
//            return Mrssi+"";
//        }
//        if (ActivityCompat.checkSelfPermission(ctx, Manifest.permission.ACCESS_BACKGROUND_LOCATION) != PackageManager.PERMISSION_GRANTED) {
//            return Mrssi+"";
//        }
//
