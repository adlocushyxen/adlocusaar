...
public class MultiProcessPreferences extends ContentProvider{
    ...
    public static final String PREFERENCE_AUTHORITY = "ADLOCUS_CONTENT";
    ...
    private static void init(Context context){
        ...
        final String host = context.getPackageName() + "." + PREFERENCE_AUTHORITY;
        matcher = new UriMatcher(UriMatcher.NO_MATCH);
        matcher.addURI(host, "*/*", MATCH_DATA);

        BASE_URI = Uri.parse("content://" + host);
    }
